# This Dockerfile is meant to be run locally to build the ProjectBullet project
...
COPY projectbullet-web-client/package.json .
COPY projectbullet-web-client/package-lock.json .
RUN npm install

COPY projectbullet-web-client .
RUN npm run build
