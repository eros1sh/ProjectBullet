...
{
    public partial class TestDataRulesDialog : UserControl
    {
        private readonly TestDataRulesDialogViewModel vm;

        public TestDataRulesDialog()
        {
            InitializeComponent();
        }
    ...
    public class TestDataRulesDialogViewModel : ViewModelBase
    {
        ...
        {
            get => regexValidation;
            set { regexValidation = value; OnPropertyChanged(); }
        }
        ...
        public ObservableCollection<SliceViewModel> SlicesCollection
        {
            ...
            set { slicesCollection = value; OnPropertyChanged(); }
        }
        ...
        public ObservableCollection<ResultViewModel> ResultsCollection
        {
            ...
            set { resultsCollection = value; OnPropertyChanged(); }
        }
    ...
    public class RegexValidationViewModel : ViewModelBase
    {
        ...
        public ISolidColorBrush Color => Passed ? Brushes.YellowGreen : Brushes.Tomato;
        public string IconValue => Passed ? "mdi-check" : "mdi-close";
