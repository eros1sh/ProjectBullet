...
{
    public partial class ProxyCheckJobOptionsDialog : UserControl
    {
    ...
    public class ProxyCheckJobOptionsViewModel : ViewModelBase
    {
        ...
        public bool StartInMode
        {
            ...
            set
            {
                if (value) StartConditionMode = StartConditionMode.Relative;
                OnPropertyChanged();
            }
        }
        ...
        public bool StartAtMode
        {
            ...
            set
            {
                if (value) StartConditionMode = StartConditionMode.Absolute;
                OnPropertyChanged();
            }
        }
        ...
        public DateTime StartAtTime
        {
            ...
            set
            {
                if (Options.StartCondition is AbsoluteTimeStartCondition abs) abs.StartAt = value;
                OnPropertyChanged();
            }
        }
        ...
        public TimeSpan StartIn
        {
            ...
            set
            {
                if (Options.StartCondition is RelativeTimeStartCondition rel) rel.StartAfter = value;
                OnPropertyChanged();
            }
        }
        #endregion
        ...
        {
            get => Options.Bots;
            set { Options.Bots = value; OnPropertyChanged(); }
        }

        public int TimeoutMilliseconds
        {
            get => Options.TimeoutMilliseconds;
            set { Options.TimeoutMilliseconds = value; OnPropertyChanged(); }
        }

        public bool CheckOnlyUntested
        {
            get => Options.CheckOnlyUntested;
            set { Options.CheckOnlyUntested = value; OnPropertyChanged(); }
        }
        ...
        {
            get => targets;
            set { targets = value.ToList(); OnPropertyChanged(); }
        }

        public ProxyCheckTarget Target
        {
            get => Options.Target;
            set { Options.Target = value; OnPropertyChanged(); }
        }
    }
}
