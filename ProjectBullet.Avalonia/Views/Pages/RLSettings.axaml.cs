...
/// <summary>
/// Interaction logic for RLSettings.axaml
/// </summary>
public partial class RLSettings : UserControl
{
    ...
    public RLSettings()
    {
        ...
        // Subscribe to text changed events after setting initial content
        customUserAgentsListTextBox.TextChanged += CustomUserAgentsChanged;
        globalBanKeysTextBox.TextChanged += GlobalBanKeysChanged;
        globalRetryKeysTextBox.TextChanged += GlobalRetryKeysChanged;
    }
