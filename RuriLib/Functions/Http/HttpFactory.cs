...
namespace RuriLib.Functions.Http
{
    public class HttpFactory
    {
        ...
        public static HttpClient GetHttpClient(Proxy proxy, HttpOptions options, CookieContainer cookieContainer,
            HttpVersionOption httpVersion = HttpVersionOption.v11)
        {
            ...
            else if (httpVersion == HttpVersionOption.v10)
            {
                client.DefaultRequestVersion = System.Net.HttpVersion.Version10;
            }
