...
namespace ProjectBullet.Console
{
    class Program
    {
        /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        class Options
        {
            ...
            [Usage(ApplicationAlias = "dotnet ProjectBullet.Console.dll")]
        ...
        private static void UpdateTitle()
        {
            ...
            catch (System.InvalidOperationException)
            {
                /*
                    ...
                    at ProjectBullet.Console.Program.UpdateTitle()
                    at ProjectBullet.Console.Program.Run(Options opts)
                    at ProjectBullet.Console.Program.<>c.<Main>b__4_0(Options opts)
                    at CommandLine.ParserResultExtensions.WithParsed[T](ParserResult`1 result, Action`1 action)
                    at ProjectBullet.Console.Program.Main(String[] args)
                 */
