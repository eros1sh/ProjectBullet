...
public class ConfigService
{
    ...
    private readonly ProjectBulletSettingsService ProjectBulletSettingsService;
    ...
    public ConfigService(IConfigRepository configRepo, ProjectBulletSettingsService ProjectBulletSettingsService)
    {
        this.configRepo = configRepo;
        this.ProjectBulletSettingsService = ProjectBulletSettingsService;
    }
    ...
    private async void LoadFromRemotes()
    {
        ...
        var tasks = ProjectBulletSettingsService.Settings.RemoteSettings.ConfigsEndpoints
